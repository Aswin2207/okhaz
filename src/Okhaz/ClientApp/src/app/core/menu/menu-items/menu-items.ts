...
const MENUITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { state: "draft-orders", name: "Draft Orders" },
      { state: "order-status", name: "Order Statuses" },
      { state: "customer-review", name: "Customer Review" },
    ],
  },
  {
    state: "products",
    ...
    children: [
      { state: "view", name: "View" },
      { state: "quick-add", name: "Quick Add" },
      { state: "detailed-add", name: "Product Detailed Add" },
      { state: "product-categories", name: "Product Categories" },
      { state: "categories-supplier", name: "Supplier by Categories" },
  ...
  },
  {
    ...
    children: [
      ...
      { state: "coupon-code", name: "Coupon Codes" },
      { state: "reel", name: "Reel" },
    ],
  },
  {
    state: "orders",
    ...
    type: "sub",
    icon: "receipt_long",
    children: [{ state: "order-sales-report", name: "Orders" }],
  },
  {
    state: "session",
    name: "My Profile",
    ...
    icon: "account_balance_wallet",
    children: [
      { state: "edit-profile", name: "Edit Profile" },
      { state: "login", name: "Logout" },
    ],
  },
  {
    state: "admin",
    ...
    children: [
      ...
      { state: "menuPermission", name: "Permission For Menu" },
