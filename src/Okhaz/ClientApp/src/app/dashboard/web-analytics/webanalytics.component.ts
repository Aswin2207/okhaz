...
import {pieChartDemoData, lineChartDemoDataOkhazrator} from "../../data/widgetDemoData.data";
...
export class WebAnalyticsComponent implements OnInit  {
  ...
  serverCardContent : any [] = [
	 ...
	 },
	 {
		...
		validity : "18/Mo",
		icon : "fa-server",
		content : "We provide 3rd okhazration server for your site.Which provide good speed in data processing and security",
  ...
  ngOnInit() {
	 ...
	 this.lineChartDemoData = lineChartDemoDataOkhazrator();
