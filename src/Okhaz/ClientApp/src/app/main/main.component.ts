...
export class MainComponent implements OnInit, OnDestroy {
  ...
  branchName: string = 'QTP Mart';
	...
	constructor(public tourService: TourService,
      ...
      this.branchName = this.branchInfo.branchname;
		...
		this.tourService.initialize([{
			anchorId: 'start.tour',
			content: 'Welcome to Okhaz admin panel!',
			placement: 'below',
			title: 'Welcome to Okhaz',
		},
		{
		...
		breadcrumbService.addFriendlyNameForRoute('/orders', 'Orders');
		breadcrumbService.addFriendlyNameForRoute('/products', 'Products');
		breadcrumbService.addFriendlyNameForRoute('/user', 'User');
		breadcrumbService.addFriendlyNameForRoute('/marketting', 'Marketting');

		breadcrumbService.addFriendlyNameForRoute('/orders/view', 'View');
		breadcrumbService.addFriendlyNameForRoute('/orders/add', 'Add');
		breadcrumbService.addFriendlyNameForRoute('/orders/export', 'Export');
		breadcrumbService.addFriendlyNameForRoute('/orders/draft-orders', 'Draft Orders');
		breadcrumbService.addFriendlyNameForRoute('/orders/order-status', 'Order Status');
		breadcrumbService.addFriendlyNameForRoute('/orders/view/detail', 'Order Detail');
    breadcrumbService.addFriendlyNameForRoute('/orders/customer-review', 'Customer Review');

    breadcrumbService.addFriendlyNameForRoute('/orders/order-sales-report', 'Order Reports');

		breadcrumbService.addFriendlyNameForRoute('/products/view', 'View');
		breadcrumbService.addFriendlyNameForRoute('/products/quick-add', 'Quick Add');
		breadcrumbService.addFriendlyNameForRoute('/products/detailed-add', 'Detailed Add');
		breadcrumbService.addFriendlyNameForRoute('/products/product-categories', 'Product Categories');
		breadcrumbService.addFriendlyNameForRoute('/products/categories-supplier', 'Categories Supplier');
		breadcrumbService.addFriendlyNameForRoute('/products/brands', 'Brands');
		breadcrumbService.addFriendlyNameForRoute('/user/customer', 'Customer');
		breadcrumbService.addFriendlyNameForRoute('/user/supplier', 'Supplier');
		breadcrumbService.addFriendlyNameForRoute('/user/employee', 'Employee');
		breadcrumbService.addFriendlyNameForRoute('/marketting/wheel-game', 'Wheel Game Setup');
		breadcrumbService.addFriendlyNameForRoute('/user/customer/detail', 'Customer Detail');
		breadcrumbService.addFriendlyNameForRoute('/user/supplier/detail', 'Supplier Detail');
		breadcrumbService.addFriendlyNameForRoute('/user/employee/detail', 'Employee Detail');
		breadcrumbService.addFriendlyNameForRoute('/marketting/wheel-game/detail', 'Wheel Game Detail');
		breadcrumbService.addFriendlyNameForRoute('/marketting/couponcode', 'Coupon Code');
	...
	/**
	  ...
	  */
	chatMenu() {
		document.getElementById("okhaz-chat").classList.toggle("show-chat-list");
	}
